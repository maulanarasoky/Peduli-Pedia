<?php
    ...
    $query = mysqli_query($conn, "SELECT ID_AYO_RELAWAN, ID_BENCANA FROM AYO_RELAWAN WHERE ID_RELAWAN = (SELECT ID_RELAWAN FROM RELAWAN WHERE USERNAME = '$user') AND STATUS = 'Selesai'");
